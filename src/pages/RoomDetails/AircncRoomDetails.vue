...
const discounts = [
  {
    title: 'Price shown is the total trip price, including additional fees and taxes.',
    description: ''
  },
        ...
        <section
          ...
          <div class="flex mb-4">
            <div
              ...
              <span>{{ roomsStore.roomDetails.info.room }} bedrooms</span>
            </div>
            ...
            <div
              ...
              <span>{{ roomsStore.roomDetails.info.bed }} beds</span>
            </div>
            ...
            <div
              ...
              <span>{{ roomsStore.roomDetails.info.toilet }} bathrooms</span>
            </div>
            ...
            <div
              ...
              <span>availble for {{ roomsStore.roomDetails.info.liveNumber }} people</span>
            </div>
          </div>
          ...
          <div class="flex items-center justify-between mb-8">
            ...
            <div class="tags">
              <el-tag
                ...
                type="success">
                {{ roomsStore.roomDetails.info.remarks }} comments
              </el-tag>
              <el-tag
          ...
          <div class="owner-details flex">
            ...
            <div class="ml-4 py-2">
              <p
                ...
                owner：{{ roomsStore.roomDetails.owner.name }}
              </p>
      ...
      <div class="form-container w-1/3">
        <div class="border border-solid border-zinc-200 pt-4 px-6">
          ...
          <div>
            ...
            <span class="text-gray-darkest text-xs font-semibold">/night</span>
          </div>
            ...
            <el-form-item :label="t('rooms.guests')" class="form-item relative">
              <el-button
                ...
                <div class="text-base text-gray-darkest">
                  <span>{{ form.adults + form.children }} Adult</span>
                  <span v-if="form.infants > 0"
                    >, {{ form.infants }} Child</span
                  >
                </div>
